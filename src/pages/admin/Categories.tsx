  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Kategoriler ve Markalar</h2>
          <p className="text-muted-foreground">Ürünlerinizi sınıflandırmak için klasör yapısı kullanın.</p>
        </div>
        <Button onClick={() => setOpen(true)} className="w-full sm:w-auto">+ Yeni Kategori Ekle</Button>
      </div>
